...
const skillsContainerOffset:number = skillsContainer.offsetTop;

const scrollDown = document.getElementById('scroll-down');
const progressBars = document.getElementsByClassName('progress-bar');

const contactInfo = document.getElementById('contact-info');
const contactInfoOffset:number = contactInfo.offsetTop;

const contactsContainer = document.getElementById('contacts-container');
const contactsContainerOffset:number = contactsContainer.offsetTop;

const mainProjects = document.getElementById('main-projects');
const mainProjectsOffset:number = mainProjects.offsetTop;

const sideProjects = document.getElementById('side-projects');
const sideProjectsOffset:number = sideProjects.offsetTop;
